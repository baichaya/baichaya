...
import { AreaVO, AreaForm, AreaQuery, AreaBuildingFloorVo } from "@/api/ibms/common/device/area/types";
 ...
 * @returns {*}
 */
export const getAreaTree = (query?: AreaQuery): AxiosPromise<AreaBuildingFloorVo[]> => {
  return request({
