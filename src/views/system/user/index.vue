      ...
      <el-col :lg="20" :xs="24">
        ...
        <el-card shadow="hover">
          <template #header>
            <el-row :gutter="10">
              <el-col :span="1.5">
                <el-button type="primary" plain @click="handleAdd()" v-has-permi="['system:user:add']" icon="Plus"
                  >新增</el-button
                >
              </el-col>
              <el-col :span="1.5">
              ...
              <right-toolbar v-model:showSearch="showSearch" @query-table="getList" :columns="columns" :search="true" />
            </el-row>
          </template>
